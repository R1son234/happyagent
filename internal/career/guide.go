		...
		Directories: []DirectoryRule{
			{
				...
				Path:             WorkspaceDirResume,
				Title:            "我的简历",
				Responsibility:   "保存用户简历原文件和普通 Markdown 简历版本；系统提取文本放入内部目录。",
			...
			},
			{
				...
				Path:             WorkspaceDirJD,
				Title:            "岗位明细",
				Responsibility:   "保存单个岗位描述、岗位画像、关键词和匹配关系；多岗位 OCR 汇总应拆成多个岗位条目。",
			...
			},
			{
				...
				Path:             WorkspaceDirExperiences,
				Title:            "面经汇总",
				Responsibility:   "保存公开面经原文、来源摘要、面经索引和来源观察；扩展题库和复习资料写入复习资料库。",
			...
			},
			{
				...
				Path:             WorkspaceDirPrepare,
				Title:            "复习资料库",
				Responsibility:   "保存由模型按材料动态归类后的题库、参考答案、知识点、复习卡片和长期可维护资料。",
			...
			},
			{
				...
				Path:             WorkspaceDirProjectPack,
				Title:            "项目专项",
				Responsibility:   "保存由 LLM 生成的项目口述、架构链路、取舍、失败模式、证据缺口和高频追问。",
				Signals:          []string{"项目专项", "项目口述", "一分钟版本", "三分钟版本", "架构链路", "项目深挖"},
				HintSignals:      []string{"project pack", "项目专项", "项目作战"},
				FilenameSignals:  []string{"project-pack", "项目专项", "项目作战"},
				RequiredSections: []string{"一句话介绍", "一分钟版本", "三分钟版本", "高频追问", "待补证据"},
				ActivePointer:    "active_project",
				SaveMode:         SaveModeMaterialDir,
			},
			{
				Type:             WorkspaceTypeMyInterviews,
				Path:             WorkspaceDirMyInterviews,
				Title:            "我的面试",
				Responsibility:   "只保存明确目标 JD / 公司 / 岗位的作战材料、真实面试记录和复盘；公开面经不得自动生成到这里。",
			...
			},
			{
				...
				Path:            filepath.Join(WorkspaceInternalDir, "record"),
				Title:           "操作记录",
